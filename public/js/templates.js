...
$templateCache.put("partials/todos/todos.html","<div class=\"container-fluid\"><div class=\"col-md-1\"><h1>Todos</h1>todos:{{todos.length}}</div><ui-view class=\"col-md-4\"></ui-view></div>");}]);